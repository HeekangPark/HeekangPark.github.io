$(document).ready(function() {
    $(".document-content .code-folder").each(function(idx, elem) {
        buildCodeFolder($(this));
    });
...
function buildCodeFolder(content) {
    buildFolder(content, folder_open_msg="코드 열기", folder_close_msg="코드 닫기");
}
