...
def loss(x, y, w):
    predict_y = x @ w
    return np.square(np.mean(np.square((y - predict_y))))
...
{% include caption-img.html src="multiple-linear-regression-sgd-training-loss.png" title="Fig.01 SGD 실행 결과 - 학습 데이터" description="각 에폭(epoch) 당 학습 데이터(training data)에 대한 손실 함수(Loss Function) 값을 나타낸 그래프" %}

{% include caption-img.html src="multiple-linear-regression-sgd-validation-loss.png" title="Fig.02 SGD 실행 결과 - 검증 데이터" description="각 에폭(epoch) 당 검증 데이터(validation data)에 대한 손실 함수(Loss Function) 값을 나타낸 그래프" %}
...
plot("Training Loss - Mini-Batch GD", training_losses)
plot("Validation Loss - Mini-Batch GD", validation_losses)
...
{% include caption-img.html src="multiple-linear-regression-minibatch-gd-training-loss.png" title="Fig.03 Mini-Batch GD 실행 결과 - 학습 데이터" description="각 에폭(epoch) 당 학습 데이터(training data)에 대한 손실 함수(Loss Function) 값을 나타낸 그래프" %}

{% include caption-img.html src="multiple-linear-regression-minibatch-gd-validation-loss.png" title="Fig.04 Mini-Batch GD 실행 결과 - 검증 데이터" description="각 에폭(epoch) 당 검증 데이터(validation data)에 대한 손실 함수(Loss Function) 값을 나타낸 그래프" %}
...
plot("Training Loss - BGD", training_losses)
plot("Validation Loss - BGD", validation_losses)
...
{% include caption-img.html src="multiple-linear-regression-bgd-training-loss.png" title="Fig.05 BGD 실행 결과 - 학습 데이터" description="각 에폭(epoch) 당 학습 데이터(training data)에 대한 손실 함수(Loss Function) 값을 나타낸 그래프" %}

{% include caption-img.html src="multiple-linear-regression-bgd-validation-loss.png" title="Fig.06 BGD 실행 결과 - 검증 데이터" description="각 에폭(epoch) 당 검증 데이터(validation data)에 대한 손실 함수(Loss Function) 값을 나타낸 그래프" %}

BGD는 수렴 속도가 늦어 에폭 수를 5000까지 늘려서 학습시켰다.