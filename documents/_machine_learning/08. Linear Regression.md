...
<div class="folder">
    <p class="folder-btn folder-show-btn">출력 결과 보기</p>
    <p class="folder-btn folder-hide-btn">출력 결과 숨기기</p>
    <div class="folder-target">
        <p>epoch 001 : loss = 0.751339, w = [ 0.993793, 0.729727 ]</p>
        <p>epoch 002 : loss = 0.633137, w = [ 1.024543, 0.721595 ]</p>
        <p>epoch 003 : loss = 0.610043, w = [ 1.055248, 0.717176 ]</p>
        <p>epoch 004 : loss = 0.586055, w = [ 1.085301, 0.712947 ]</p>
        <p>epoch 005 : loss = 0.563054, w = [ 1.114701, 0.708812 ]</p>
        <p>epoch 006 : loss = 0.541049, w = [ 1.143460, 0.704768 ]</p>
        <p>epoch 007 : loss = 0.519997, w = [ 1.171594, 0.700812 ]</p>
        <p>epoch 008 : loss = 0.499857, w = [ 1.199114, 0.696942 ]</p>
        <p>epoch 009 : loss = 0.480591, w = [ 1.226036, 0.693156 ]</p>
        <p>epoch 010 : loss = 0.462159, w = [ 1.252371, 0.689453 ]</p>
        <p>epoch 011 : loss = 0.444527, w = [ 1.278134, 0.685830 ]</p>
        <p>epoch 012 : loss = 0.427660, w = [ 1.303335, 0.682286 ]</p>
        <p>epoch 013 : loss = 0.411524, w = [ 1.327987, 0.678819 ]</p>
        <p>epoch 014 : loss = 0.396088, w = [ 1.352103, 0.675428 ]</p>
        <p>epoch 015 : loss = 0.381322, w = [ 1.375694, 0.672110 ]</p>
        <p>epoch 016 : loss = 0.367197, w = [ 1.398771, 0.668865 ]</p>
        <p>epoch 017 : loss = 0.353684, w = [ 1.421346, 0.665691 ]</p>
        <p>epoch 018 : loss = 0.340758, w = [ 1.443429, 0.662585 ]</p>
        <p>epoch 019 : loss = 0.328394, w = [ 1.465031, 0.659547 ]</p>
        <p>epoch 020 : loss = 0.316566, w = [ 1.486164, 0.656576 ]</p>
        <p>epoch 021 : loss = 0.305252, w = [ 1.506836, 0.653669 ]</p>
        <p>epoch 022 : loss = 0.294430, w = [ 1.527057, 0.650825 ]</p>
        <p>epoch 023 : loss = 0.284077, w = [ 1.546839, 0.648043 ]</p>
        <p>epoch 024 : loss = 0.274175, w = [ 1.566190, 0.645322 ]</p>
        <p>epoch 025 : loss = 0.264703, w = [ 1.585120, 0.642660 ]</p>
        <p>epoch 026 : loss = 0.255643, w = [ 1.603637, 0.640056 ]</p>
        <p>epoch 027 : loss = 0.246977, w = [ 1.621752, 0.637509 ]</p>
        <p>epoch 028 : loss = 0.238688, w = [ 1.639472, 0.635017 ]</p>
        <p>epoch 029 : loss = 0.230759, w = [ 1.656806, 0.632579 ]</p>
        <p>epoch 030 : loss = 0.223175, w = [ 1.673763, 0.630195 ]</p>
        <p>epoch 031 : loss = 0.215922, w = [ 1.690350, 0.627862 ]</p>
        <p>epoch 032 : loss = 0.208984, w = [ 1.706577, 0.625580 ]</p>
        <p>epoch 033 : loss = 0.202348, w = [ 1.722450, 0.623348 ]</p>
        <p>epoch 034 : loss = 0.196002, w = [ 1.737978, 0.621164 ]</p>
        <p>epoch 035 : loss = 0.189931, w = [ 1.753167, 0.619028 ]</p>
        <p>epoch 036 : loss = 0.184126, w = [ 1.768026, 0.616939 ]</p>
        <p>epoch 037 : loss = 0.178573, w = [ 1.782562, 0.614895 ]</p>
        <p>epoch 038 : loss = 0.173263, w = [ 1.796780, 0.612895 ]</p>
        <p>epoch 039 : loss = 0.168184, w = [ 1.810690, 0.610939 ]</p>
        <p>epoch 040 : loss = 0.163326, w = [ 1.824296, 0.609026 ]</p>
        <p>epoch 041 : loss = 0.158681, w = [ 1.837606, 0.607154 ]</p>
        <p>epoch 042 : loss = 0.154238, w = [ 1.850627, 0.605323 ]</p>
        <p>epoch 043 : loss = 0.149990, w = [ 1.863364, 0.603532 ]</p>
        <p>epoch 044 : loss = 0.145927, w = [ 1.875824, 0.601780 ]</p>
        <p>epoch 045 : loss = 0.142041, w = [ 1.888012, 0.600066 ]</p>
        <p>epoch 046 : loss = 0.138326, w = [ 1.899935, 0.598389 ]</p>
        <p>epoch 047 : loss = 0.134772, w = [ 1.911598, 0.596749 ]</p>
        <p>epoch 048 : loss = 0.131375, w = [ 1.923008, 0.595145 ]</p>
        <p>epoch 049 : loss = 0.128126, w = [ 1.934169, 0.593575 ]</p>
        <p>epoch 050 : loss = 0.125019, w = [ 1.945087, 0.592040 ]</p>
        <p>epoch 051 : loss = 0.122048, w = [ 1.955768, 0.590538 ]</p>
        <p>epoch 052 : loss = 0.119207, w = [ 1.966215, 0.589069 ]</p>
        <p>epoch 053 : loss = 0.116491, w = [ 1.976436, 0.587631 ]</p>
        <p>epoch 054 : loss = 0.113893, w = [ 1.986434, 0.586225 ]</p>
        <p>epoch 055 : loss = 0.111410, w = [ 1.996214, 0.584850 ]</p>
        <p>epoch 056 : loss = 0.109035, w = [ 2.005781, 0.583505 ]</p>
        <p>epoch 057 : loss = 0.106765, w = [ 2.015140, 0.582189 ]</p>
        <p>epoch 058 : loss = 0.104595, w = [ 2.024295, 0.580901 ]</p>
        <p>epoch 059 : loss = 0.102520, w = [ 2.033251, 0.579642 ]</p>
        ...
        <p>epoch 123 : loss = 0.060282, w = [ 2.337286, 0.536887 ]</p>
        ...
        <p>epoch 187 : loss = 0.058293, w = [ 2.411604, 0.526436 ]</p>
...
<div class="folder">
    ...
    <p class="folder-btn folder-hide-btn">출력 결과 숨기기</p>
    <div class="folder-target">
        <p>epoch 001 : loss = 1.061460, w = [ 0.983210, 0.804476 ]</p>
        <p>epoch 002 : loss = 0.720008, w = [ 0.986393, 0.774295 ]</p>
        <p>epoch 003 : loss = 0.652471, w = [ 0.992222, 0.760671 ]</p>
        <p>epoch 004 : loss = 0.635013, w = [ 0.999158, 0.754127 ]</p>
        <p>epoch 005 : loss = 0.626755, w = [ 1.006543, 0.750613 ]</p>
        <p>epoch 006 : loss = 0.620232, w = [ 1.014096, 0.748396 ]</p>
        <p>epoch 007 : loss = 0.614080, w = [ 1.021697, 0.746738 ]</p>
        <p>epoch 008 : loss = 0.608050, w = [ 1.029295, 0.745323 ]</p>
        <p>epoch 009 : loss = 0.602094, w = [ 1.036868, 0.744016 ]</p>
        <p>epoch 010 : loss = 0.596204, w = [ 1.044406, 0.742758 ]</p>
        <p>epoch 011 : loss = 0.590379, w = [ 1.051907, 0.741525 ]</p>
        <p>epoch 012 : loss = 0.584616, w = [ 1.059369, 0.740307 ]</p>
        <p>epoch 013 : loss = 0.578915, w = [ 1.066791, 0.739098 ]</p>
        <p>epoch 014 : loss = 0.573276, w = [ 1.074173, 0.737898 ]</p>
        <p>epoch 015 : loss = 0.567698, w = [ 1.081515, 0.736704 ]</p>
        <p>epoch 016 : loss = 0.562180, w = [ 1.088817, 0.735518 ]</p>
        <p>epoch 017 : loss = 0.556722, w = [ 1.096080, 0.734338 ]</p>
        <p>epoch 018 : loss = 0.551322, w = [ 1.103303, 0.733164 ]</p>
        <p>epoch 019 : loss = 0.545981, w = [ 1.110488, 0.731997 ]</p>
        <p>epoch 020 : loss = 0.540697, w = [ 1.117633, 0.730835 ]</p>
        <p>epoch 021 : loss = 0.535471, w = [ 1.124740, 0.729681 ]</p>
        <p>epoch 022 : loss = 0.530300, w = [ 1.131809, 0.728532 ]</p>
        <p>epoch 023 : loss = 0.525186, w = [ 1.138839, 0.727390 ]</p>
        <p>epoch 024 : loss = 0.520127, w = [ 1.145831, 0.726254 ]</p>
        <p>epoch 025 : loss = 0.515122, w = [ 1.152786, 0.725124 ]</p>
        <p>epoch 026 : loss = 0.510172, w = [ 1.159703, 0.724000 ]</p>
        <p>epoch 027 : loss = 0.505274, w = [ 1.166582, 0.722882 ]</p>
        <p>epoch 028 : loss = 0.500430, w = [ 1.173424, 0.721771 ]</p>
        <p>epoch 029 : loss = 0.495638, w = [ 1.180229, 0.720665 ]</p>
        <p>epoch 030 : loss = 0.490898, w = [ 1.186997, 0.719565 ]</p>
        <p>epoch 031 : loss = 0.486209, w = [ 1.193729, 0.718472 ]</p>
        <p>epoch 032 : loss = 0.481570, w = [ 1.200424, 0.717384 ]</p>
        <p>epoch 033 : loss = 0.476981, w = [ 1.207083, 0.716302 ]</p>
        ...
        <p>epoch 097 : loss = 0.266411, w = [ 1.566168, 0.657959 ]</p>
        ...
        <p>epoch 161 : loss = 0.161258, w = [ 1.819920, 0.616730 ]</p>
        ...
        <p>epoch 225 : loss = 0.108747, w = [ 1.999237, 0.587595 ]</p>
        ...
        <p>epoch 289 : loss = 0.082525, w = [ 2.125953, 0.567007 ]</p>
        ...
        <p>epoch 353 : loss = 0.069431, w = [ 2.215499, 0.552457 ]</p>
        ...
        <p>epoch 402 : loss = 0.064045, w = [ 2.265853, 0.544276 ]</p>
        <p>epoch 403 : loss = 0.063962, w = [ 2.266748, 0.544131 ]</p>
        <p>epoch 404 : loss = 0.063880, w = [ 2.267638, 0.543986 ]</p>
        <p>epoch 405 : loss = 0.063799, w = [ 2.268523, 0.543842 ]</p>
        <p>epoch 406 : loss = 0.063719, w = [ 2.269403, 0.543699 ]</p>
        <p>epoch 407 : loss = 0.063639, w = [ 2.270279, 0.543557 ]</p>
        <p>epoch 408 : loss = 0.063561, w = [ 2.271149, 0.543415 ]</p>
        <p>epoch 409 : loss = 0.063483, w = [ 2.272015, 0.543275 ]</p>
        <p>epoch 410 : loss = 0.063406, w = [ 2.272877, 0.543135 ]</p>
        <p>epoch 411 : loss = 0.063331, w = [ 2.273733, 0.542996 ]</p>
        <p>epoch 412 : loss = 0.063255, w = [ 2.274585, 0.542857 ]</p>
        <p>epoch 413 : loss = 0.063181, w = [ 2.275433, 0.542720 ]</p>
        <p>epoch 414 : loss = 0.063108, w = [ 2.276276, 0.542583 ]</p>
        <p>epoch 415 : loss = 0.063035, w = [ 2.277114, 0.542446 ]</p>
        <p>epoch 416 : loss = 0.062963, w = [ 2.277948, 0.542311 ]</p>
        <p>epoch 417 : loss = 0.062892, w = [ 2.278777, 0.542176 ]</p>
        <p>epoch 418 : loss = 0.062821, w = [ 2.279602, 0.542042 ]</p>
        <p>epoch 419 : loss = 0.062752, w = [ 2.280422, 0.541909 ]</p>
        <p>epoch 420 : loss = 0.062683, w = [ 2.281238, 0.541776 ]</p>
        <p>epoch 421 : loss = 0.062615, w = [ 2.282049, 0.541644 ]</p>
        <p>epoch 422 : loss = 0.062547, w = [ 2.282856, 0.541513 ]</p>
        <p>epoch 423 : loss = 0.062481, w = [ 2.283659, 0.541383 ]</p>
        <p>epoch 424 : loss = 0.062415, w = [ 2.284457, 0.541253 ]</p>
        <p>epoch 425 : loss = 0.062349, w = [ 2.285251, 0.541124 ]</p>
        <p>epoch 426 : loss = 0.062285, w = [ 2.286041, 0.540996 ]</p>
        <p>epoch 427 : loss = 0.062221, w = [ 2.286826, 0.540868 ]</p>
        <p>epoch 428 : loss = 0.062158, w = [ 2.287608, 0.540741 ]</p>
        <p>epoch 429 : loss = 0.062095, w = [ 2.288385, 0.540615 ]</p>
        <p>epoch 430 : loss = 0.062034, w = [ 2.289157, 0.540490 ]</p>
        <p>epoch 431 : loss = 0.061973, w = [ 2.289926, 0.540365 ]</p>
        <p>epoch 432 : loss = 0.061912, w = [ 2.290690, 0.540240 ]</p>
        <p>epoch 433 : loss = 0.061852, w = [ 2.291451, 0.540117 ]</p>
        <p>epoch 434 : loss = 0.061793, w = [ 2.292207, 0.539994 ]</p>
        <p>epoch 435 : loss = 0.061735, w = [ 2.292959, 0.539872 ]</p>
        <p>epoch 436 : loss = 0.061677, w = [ 2.293707, 0.539750 ]</p>
        <p>epoch 437 : loss = 0.061619, w = [ 2.294451, 0.539629 ]</p>
        <p>epoch 438 : loss = 0.061563, w = [ 2.295191, 0.539509 ]</p>
        <p>epoch 439 : loss = 0.061507, w = [ 2.295927, 0.539390 ]</p>
        <p>epoch 440 : loss = 0.061451, w = [ 2.296659, 0.539271 ]</p>
        <p>epoch 441 : loss = 0.061396, w = [ 2.297387, 0.539152 ]</p>
        <p>epoch 442 : loss = 0.061342, w = [ 2.298111, 0.539035 ]</p>
        <p>epoch 443 : loss = 0.061288, w = [ 2.298831, 0.538918 ]</p>
        <p>epoch 444 : loss = 0.061235, w = [ 2.299547, 0.538801 ]</p>
        <p>epoch 445 : loss = 0.061183, w = [ 2.300260, 0.538686 ]</p>
        <p>epoch 446 : loss = 0.061131, w = [ 2.300968, 0.538571 ]</p>
        <p>epoch 447 : loss = 0.061080, w = [ 2.301673, 0.538456 ]</p>
        <p>epoch 448 : loss = 0.061029, w = [ 2.302374, 0.538342 ]</p>
        <p>epoch 449 : loss = 0.060978, w = [ 2.303071, 0.538229 ]</p>
        <p>epoch 450 : loss = 0.060929, w = [ 2.303764, 0.538116 ]</p>
        <p>epoch 451 : loss = 0.060879, w = [ 2.304454, 0.538004 ]</p>
        <p>epoch 452 : loss = 0.060831, w = [ 2.305140, 0.537893 ]</p>
        <p>epoch 453 : loss = 0.060783, w = [ 2.305822, 0.537782 ]</p>
        <p>epoch 454 : loss = 0.060735, w = [ 2.306500, 0.537672 ]</p>
        <p>epoch 455 : loss = 0.060688, w = [ 2.307175, 0.537562 ]</p>
        <p>epoch 456 : loss = 0.060641, w = [ 2.307846, 0.537453 ]</p>
        <p>epoch 457 : loss = 0.060595, w = [ 2.308514, 0.537345 ]</p>
        <p>epoch 458 : loss = 0.060550, w = [ 2.309177, 0.537237 ]</p>
        <p>epoch 459 : loss = 0.060505, w = [ 2.309838, 0.537129 ]</p>
        <p>epoch 460 : loss = 0.060460, w = [ 2.310494, 0.537023 ]</p>
        <p>epoch 461 : loss = 0.060416, w = [ 2.311148, 0.536917 ]</p>
        <p>epoch 462 : loss = 0.060372, w = [ 2.311797, 0.536811 ]</p>
        <p>epoch 463 : loss = 0.060329, w = [ 2.312443, 0.536706 ]</p>
        <p>epoch 464 : loss = 0.060286, w = [ 2.313086, 0.536602 ]</p>
        <p>epoch 465 : loss = 0.060244, w = [ 2.313725, 0.536498 ]</p>
        <p>epoch 466 : loss = 0.060202, w = [ 2.314361, 0.536395 ]</p>
        <p>epoch 467 : loss = 0.060161, w = [ 2.314993, 0.536292 ]</p>
        <p>epoch 468 : loss = 0.060120, w = [ 2.315622, 0.536190 ]</p>
        <p>epoch 469 : loss = 0.060079, w = [ 2.316247, 0.536088 ]</p>
        <p>epoch 470 : loss = 0.060039, w = [ 2.316869, 0.535987 ]</p>
        <p>epoch 471 : loss = 0.060000, w = [ 2.317488, 0.535887 ]</p>
        <p>epoch 472 : loss = 0.059960, w = [ 2.318103, 0.535787 ]</p>
        <p>epoch 473 : loss = 0.059922, w = [ 2.318715, 0.535687 ]</p>
        <p>epoch 474 : loss = 0.059883, w = [ 2.319324, 0.535588 ]</p>
        <p>epoch 475 : loss = 0.059845, w = [ 2.319929, 0.535490 ]</p>
        <p>epoch 476 : loss = 0.059808, w = [ 2.320531, 0.535392 ]</p>
        <p>epoch 477 : loss = 0.059771, w = [ 2.321130, 0.535295 ]</p>
        <p>epoch 478 : loss = 0.059734, w = [ 2.321726, 0.535198 ]</p>
        <p>epoch 479 : loss = 0.059698, w = [ 2.322318, 0.535102 ]</p>
        <p>epoch 480 : loss = 0.059662, w = [ 2.322907, 0.535006 ]</p>
        <p>epoch 481 : loss = 0.059626, w = [ 2.323493, 0.534911 ]</p>
        <p>epoch 482 : loss = 0.059591, w = [ 2.324076, 0.534816 ]</p>
        <p>epoch 483 : loss = 0.059556, w = [ 2.324656, 0.534722 ]</p>
        <p>epoch 484 : loss = 0.059522, w = [ 2.325232, 0.534628 ]</p>
        <p>epoch 485 : loss = 0.059488, w = [ 2.325806, 0.534535 ]</p>
        <p>epoch 486 : loss = 0.059454, w = [ 2.326376, 0.534442 ]</p>
        <p>epoch 487 : loss = 0.059421, w = [ 2.326943, 0.534350 ]</p>
        <p>epoch 488 : loss = 0.059388, w = [ 2.327507, 0.534259 ]</p>
        <p>epoch 489 : loss = 0.059356, w = [ 2.328069, 0.534167 ]</p>
        <p>epoch 490 : loss = 0.059323, w = [ 2.328627, 0.534077 ]</p>
        <p>epoch 491 : loss = 0.059291, w = [ 2.329182, 0.533987 ]</p>
        <p>epoch 492 : loss = 0.059260, w = [ 2.329734, 0.533897 ]</p>
        <p>epoch 493 : loss = 0.059229, w = [ 2.330283, 0.533808 ]</p>
        <p>epoch 494 : loss = 0.059198, w = [ 2.330829, 0.533719 ]</p>
        <p>epoch 495 : loss = 0.059167, w = [ 2.331372, 0.533631 ]</p>
        <p>epoch 496 : loss = 0.059137, w = [ 2.331912, 0.533543 ]</p>
        <p>epoch 497 : loss = 0.059107, w = [ 2.332449, 0.533456 ]</p>
        <p>epoch 498 : loss = 0.059078, w = [ 2.332984, 0.533369 ]</p>
        <p>epoch 499 : loss = 0.059048, w = [ 2.333515, 0.533282 ]</p>
        <p>epoch 500 : loss = 0.059020, w = [ 2.334044, 0.533197 ]</p>
    </div>
</div>
